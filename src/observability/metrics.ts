...
export type OperationalMetric = 'cache_hit' | 'cache_failure' | 'credential_refresh_failure' | 'decision_store_failure' | 'health_store_failure' | 'idempotency_store_failure' | 'reconciliation_failure' | 'registry_refresh_failure' | 'reservation_recovered' | 'rollout_observation_failure' | 'rollout_auto_rollback' | 'shadow_job_dropped' | 'shadow_execution_failure' | 'shadow_budget_rejection' | 'shadow_observation_recorded' | 'shadow_reservation_recovered';
...
const operationalNames: readonly OperationalMetric[] = ['cache_hit', 'cache_failure', 'credential_refresh_failure', 'decision_store_failure', 'health_store_failure', 'idempotency_store_failure', 'reconciliation_failure', 'registry_refresh_failure', 'reservation_recovered', 'rollout_observation_failure', 'rollout_auto_rollback', 'shadow_job_dropped', 'shadow_execution_failure', 'shadow_budget_rejection', 'shadow_observation_recorded', 'shadow_reservation_recovered'];
